...
async def mock_tool_registry():
    ...
    async def mock_rag_execute(params: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
        return {
    ...
    async def mock_json_execute(params: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
...
@pytest.fixture
async def mcp_server(mock_tool_registry, mock_router, mock_permission_manager, mock_cache):
...
class TestMCPServerIntegration:
    ...
    async def test_error_handling(self, mcp_server):
        ...
        async def mock_failing_execute(params: Dict[str, Any], context: Dict[str, Any]) -> Dict[str, Any]:
