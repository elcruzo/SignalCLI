...
class JSONValidator:
    ...
    def validate_and_format(
        self, data: Union[str, Dict[str, Any]], schema: Dict[str, Any]
    ) -> Dict[str, Any]:
        """
    ...
    def _apply_constraints(self, data: Any, schema: Dict[str, Any]) -> Any:
    ...
    def _format_output(self, data: Any, schema: Dict[str, Any]) -> Any:
